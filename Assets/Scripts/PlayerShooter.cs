...
public class PlayerShooter : MonoBehaviour
{
    ...
    private void UpdateAimTarget()
    {
        ...
        var ray = playerCamera.ViewportToScreenPoint(new Vector3(0.5f, 0.5f, 0f));

        if(Physics.Raycast(ray, playerCamera.transform.forward, out hit, gun.fireDistance, ~excludeTarget))
        {
            aimPoint = hit.point;
